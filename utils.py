...
def TCO_from_price_per_unit(price_per_unit,offer,actual):
    actual.price_per_unit = price_per_unit
        ...
        {'{'}{
            {
                ...
                "contract_inflation_by_year": offer['contract_inflation_by_year'],
...
def extract_levers_from_text(
    ...
    response_schemas = [
        ...
        ResponseSchema(name="payment_term",description="Expected date of delivery"),
        ResponseSchema(name="payment_term_markup",description="Expected date of delivery"),
        ResponseSchema(name="delivery_timeline",description="Expected date of delivery"),
        ResponseSchema(name="contract_period",description="Expected date of delivery"),
        ResponseSchema(name="contract_inflation_by_year",description="Expected date of delivery"),
        ResponseSchema(name="rebates_threshold_unit",description="Expected date of delivery"),
        ResponseSchema(name="rebates_discount",description="Expected date of delivery"),
        ResponseSchema(name="warranty",description="Expected date of delivery"),
        ResponseSchema(name="incoterms",description="Expected date of delivery"),
    ]
